package com.simm.thingsboard.service.security;
...
public class SecurityConfig extends WebSecurityConfigurerAdapter {
    ...
    protected void configure(HttpSecurity http) throws Exception {
        http.cors().and()
                ...
                .antMatchers(HttpMethod.POST, "/mensajes").permitAll()
                .antMatchers(HttpMethod.POST, "/garantiasMotocicletas").permitAll()
